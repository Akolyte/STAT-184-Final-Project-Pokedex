...
master %>%
  ...
  ggplot(aes(x = type, y = exp(avg_hp))) + 
  geom_col() + 
...
master %>%
  ...
  ggplot(aes(x = type, y = avg_defense)) + 
  geom_col() + 
  theme(axis.text.x = element_text(angle = 30, hjust=1))
...
master %>%
  ...
  ggplot(aes(x = type, y = avg_special_attack)) + 
  geom_col() + 
  theme(axis.text.x = element_text(angle = 30, hjust=1))
...
master %>%
  ...
  ggplot(aes(x = type, y = avg_special_defense)) + 
  geom_col() + 
  theme(axis.text.x = element_text(angle = 30, hjust=1))
